...
The following 5 visualization give a glimpse into the summary statistics of the data
...
ggplot(annual_damage, aes(x = YEAR, y = full_damage_cost)) +
  ...
  labs(
    title = "Annual Inflation-Adjusted Total Damage Costs from Tornadoes in Alabama",
    x = "Year",
